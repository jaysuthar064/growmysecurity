...
$quote_services = [ 'Branding Services', 'Search Engine Optimisation', 'Fractional CMO Services', 'Social Media Marketing', 'Website Design', 'Website Development', 'Advertising Services', 'AI Solutions' ];
$contact_details = [ [ 'icon' => 'phone', 'label' => 'Phone', 'value' => '(623) 282-1778' ], [ 'icon' => 'email', 'label' => 'Email', 'value' => 'info@growmysecuritycompany.com' ], [ 'icon' => 'office', 'label' => 'Head Office', 'value' => 'Chicago, IL, United States' ], [ 'icon' => 'hours', 'label' => 'Working Hours', 'value' => 'Monday-Friday: 09:00AM - 06:00PM' ] ];
...
<div class="gms-homepage">
						...
						<div class="swiper-slide">
							<article class="gms-testimonial-card">
								<div class="gms-testimonial-card__logo">
									<?php echo $testimonial_logo_markup( (array) $testimonial ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
								</div>
								...
								<div class="gms-testimonial-card__footer">
									<div class="gms-testimonial-card__stars" aria-hidden="true">
										<?php for ( $i = 0; $i < 5; $i++ ) : ?>
											<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z" fill="var(--gms-home-accent)"/></svg>
										<?php endfor; ?>
									</div>
	...
	<section id="quote" class="gms-homepage-section gms-homepage-section--quote">
		<div class="gms-homepage-shell">
			<div class="gms-homepage-quote"><div class="gms-homepage-quote__content"><div class="gms-homepage-chip"><span class="gms-homepage-chip__icon gms-homepage-chip__icon--contact" aria-hidden="true"></span><span><?php esc_html_e( 'Contact Us', 'grow-my-security' ); ?></span></div><h2><?php esc_html_e( 'Get your free quote', 'grow-my-security' ); ?></h2><p><?php esc_html_e( 'Supercharge your online presence with a tailored digital marketing strategy. Fill out the form today to get a personalized consultation and quote within 24-48 hours - no hidden fees, no obligations.', 'grow-my-security' ); ?></p><div class="gms-homepage-quote__services"><h3><?php esc_html_e( "What services you'll get", 'grow-my-security' ); ?></h3><ul><?php foreach ( $quote_services as $quote_service ) : ?><li><span class="gms-homepage-inline-icon gms-homepage-inline-icon--check" aria-hidden="true"></span><span><?php echo esc_html( $quote_service ); ?></span></li><?php endforeach; ?></ul></div><div class="gms-homepage-quote__details"><?php foreach ( $contact_details as $contact_detail ) : ?><div class="gms-homepage-quote__detail"><div class="gms-homepage-quote__detail-icon" aria-hidden="true"><?php echo $render_contact_icon( $contact_detail['icon'] ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></div><div><p><?php echo esc_html( $contact_detail['label'] ); ?></p><h3><?php if ( 'phone' === $contact_detail['icon'] ) : ?><a href="tel:<?php echo esc_attr( preg_replace( '/[^0-9+]/', '', (string) $contact_detail['value'] ) ); ?>"><?php echo esc_html( $contact_detail['value'] ); ?></a><?php elseif ( 'email' === $contact_detail['icon'] ) : ?><a href="mailto:<?php echo esc_attr( $contact_detail['value'] ); ?>"><?php echo esc_html( $contact_detail['value'] ); ?></a><?php else : ?><?php echo esc_html( $contact_detail['value'] ); ?><?php endif; ?></h3></div></div><?php endforeach; ?></div></div><div class="gms-homepage-quote__form-card"><h3><?php esc_html_e( 'Start your project today - no obligation', 'grow-my-security' ); ?></h3><div class="gms-homepage-quote__form-wrapper"><label class="gms-homepage-field gms-homepage-field--active"><span><?php esc_html_e( 'Full Name', 'grow-my-security' ); ?></span><input type="text" name="full_name" placeholder="<?php esc_attr_e( 'Enter full name', 'grow-my-security' ); ?>" autocomplete="name"></label><label class="gms-homepage-field"><span><?php esc_html_e( 'Email Address', 'grow-my-security' ); ?></span><input type="email" name="email" placeholder="<?php esc_attr_e( 'Enter email address', 'grow-my-security' ); ?>" autocomplete="email"></label><label class="gms-homepage-field"><span><?php esc_html_e( 'Phone', 'grow-my-security' ); ?></span><input type="tel" name="phone" placeholder="<?php esc_attr_e( '(555) 123-4567', 'grow-my-security' ); ?>" autocomplete="tel"></label><label class="gms-homepage-field"><span><?php esc_html_e( "Services you're interested in", 'grow-my-security' ); ?></span><span class="gms-homepage-select-wrap"><select name="service_interest"><?php foreach ( $quote_services as $quote_service ) : ?><option value="<?php echo esc_attr( $quote_service ); ?>"<?php selected( 'Fractional CMO Services', $quote_service ); ?>><?php echo esc_html( $quote_service ); ?></option><?php endforeach; ?></select></span></label><label class="gms-homepage-field"><span><?php esc_html_e( 'Project description', 'grow-my-security' ); ?></span><textarea name="message" placeholder="<?php esc_attr_e( 'Tell us more about your project, timeline, budget, or other specific requirements', 'grow-my-security' ); ?>"></textarea></label><a href="https://meetings.hubspot.com/rumore/grow-my-security-company-?uuid=fa51c8d1-f823-42df-91ac-85496638ef83" class="gms-homepage-button gms-homepage-button--primary gms-homepage-button--full" style="text-decoration: none; display: flex; text-align: center; justify-content: center;"><span><?php esc_html_e( 'Get My Free Quote', 'grow-my-security' ); ?></span><span class="gms-homepage-button__arrow" aria-hidden="true"></span></a></div><div class="gms-homepage-quote__reassurance"><span><span class="gms-homepage-inline-icon gms-homepage-inline-icon--check" aria-hidden="true"></span><?php esc_html_e( '24-48 hour response', 'grow-my-security' ); ?></span><span><span class="gms-homepage-inline-icon gms-homepage-inline-icon--check" aria-hidden="true"></span><?php esc_html_e( 'No spam, ever', 'grow-my-security' ); ?></span><span><span class="gms-homepage-inline-icon gms-homepage-inline-icon--check" aria-hidden="true"></span><?php esc_html_e( 'Local experts', 'grow-my-security' ); ?></span></div></div></div>
		</div>
	</section>	<?php endif; ?>
