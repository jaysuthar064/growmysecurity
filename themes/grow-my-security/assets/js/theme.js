document.addEventListener('DOMContentLoaded', () => {
  ...
  if (navToggle && nav) {
    ...
    const mobileNavMaxWidth = body.classList.contains('home') || body.classList.contains('gms-approved-route--services') || body.classList.contains('gms-approved-route--podcast') ? 1100 : 980;
